...
[CodeMirror 6](https://codemirror.net/6/) themes ported from [Sugar High](https://sugar-high.vercel.app) for use with [`@uiw/react-codemirror`](https://github.com/uiw/react-codemirror).
